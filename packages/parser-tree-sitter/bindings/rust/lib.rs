...
//! let language = tree_sitter_agentscript::LANGUAGE;
//! parser
//!     .set_language(&language.into())
//!     .expect("Error loading AgentScript parser");
...
pub const LANGUAGE: LanguageFn = unsafe { LanguageFn::from_raw(tree_sitter_agentscript) };
