/**
 * The list of (`.agent` source, expected `.yaml` output) pairs driving both
 * the parity test (`compare-all.test.ts`) and the regen script
 * (`scripts/regen-fixtures.ts`). Keeping them in a shared module ensures the
 * two stay in sync.
 */
export const FIXTURE_PAIRS: [string, string][] = [
  ...
  ['adecco.agent', 'adecco_dsl.yaml'],
  ['deep_supervision.agent', 'deep_supervision_dsl.yaml'],
  ['aron_steel_thread.agent', 'aron_steel_thread_dsl.yaml'],
  ...
  ['pronto_booth_readiness.agent', 'pronto_booth_readiness_dsl.yaml'],
  ['pronto_customer_support.agent', 'pronto_customer_support_dsl.yaml'],
  ['after_reasoning_delegate.agent', 'after_reasoning_delegate_dsl.yaml'],
  ['siemens.agent', 'siemens_dsl.yaml'],
  // New fixtures from Python repo
  ['adecco_current.agent', 'adecco_current_dsl.yaml'],
  ['appointment_scheduler.agent', 'appointment_scheduler_dsl.yaml'],
  ['aronscript.agent', 'aronscript_dsl.yaml'],
  ...
  ['edge_action_alias_targets.agent', 'edge_action_alias_targets_dsl.yaml'],
  ...
  ['edge_action_placeholder.agent', 'edge_action_placeholder_dsl.yaml'],
  ...
  ['connection_inputs.agent', 'connection_inputs_dsl.yaml'],
  ...
  // ['edge_conn_customizable.agent', 'edge_conn_customizable_dsl.yaml'],
  [
  ...
  ['edge_end_session_basic.agent', 'edge_end_session_basic_dsl.yaml'],
  ...
  ['commerce_shopper_agent.agent', 'commerce_shopper_agent_dsl.yaml'],
  ['byon_minimal.agent', 'byon_minimal_dsl.yaml'],
  ['byon_only_start_agent.agent', 'byon_only_start_agent_dsl.yaml'],
  ['byon_node_accesstoken.agent', 'byon_node_accesstoken_dsl.yaml'],
  ['byon_shopper_agent.agent', 'byon_shopper_agent_dsl.yaml'],
  ['shopper_prod.agent', 'shopper_prod_dsl.yaml'],
  // Connection fixtures
  [
    'connection_with_unified_email.agent',
    'connection_with_unified_email_dsl.yaml',
  ],
];
