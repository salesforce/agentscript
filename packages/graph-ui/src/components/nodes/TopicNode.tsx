...
import { getBlockTypeConfig } from '../../tokens/block-type-config';
import { GRAPH } from '../../tokens/graph-tokens';
...
export function TopicNode({ data, selected }: NodeProps<GraphNode>) {
  ...
  const variantClasses = isStartAgent
    ? 'bg-indigo-50 dark:bg-zinc-800 border-indigo-300 dark:border-indigo-500/40 dark:shadow-indigo-500/10 hover:border-indigo-400 dark:hover:border-indigo-400/60'
    : 'bg-sky-50 dark:bg-zinc-800 border-sky-300 dark:border-sky-500/40 dark:shadow-sky-500/10 hover:border-sky-400 dark:hover:border-sky-400/60';
