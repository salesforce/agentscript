...
export function BuildInstructionsNode({ data }: NodeProps<GraphNode>) {
  return (
    <div className="relative min-w-[260px] rounded-xl border border-indigo-300 bg-gradient-to-r from-indigo-50/60 to-white shadow-sm dark:border-indigo-500/40 dark:from-indigo-950/20 dark:to-zinc-800">
      <NodeHandles
