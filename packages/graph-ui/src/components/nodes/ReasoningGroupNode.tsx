 ...
 */
export function ReasoningGroupNode({ data }: NodeProps<GraphNode>) {
  ...
  if (isEmpty && !isLoop) {
    return (
      <div
        className="relative rounded-2xl border border-dashed border-gray-400 bg-gray-50/10 dark:border-zinc-600 dark:bg-slate-400/5"
  ...
  return (
    <div
      className={`relative rounded-2xl border ${
        isLoop
          ? 'border-indigo-300 bg-linear-to-b from-indigo-50/20 to-transparent dark:border-indigo-400/60 dark:from-indigo-950/15 dark:to-transparent'
          : 'border-gray-400 bg-gray-50/10 dark:border-zinc-600 dark:bg-slate-400/5'
      }`}
      style={containerStyle}
    >
      {groupHandles}
