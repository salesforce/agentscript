...
export function StartNode({ data, selected }: NodeProps<GraphNode>) {
  return (
    <div
      className={`flex items-center gap-3 rounded-xl border bg-green-50 px-5 py-3.5 shadow-lg transition-all duration-150 dark:bg-zinc-800 dark:shadow-green-500/10 ${
        selected
          ? 'border-blue-400 ring-2 ring-blue-400/20 shadow-xl shadow-blue-500/10 dark:ring-blue-400/15 dark:shadow-blue-500/8'
          : 'border-green-500 dark:border-green-500/50 hover:border-green-600 dark:hover:border-green-400/70 hover:shadow-xl'
      }`}
    >
      <NodeHandles
        sides={START_SIDES}
