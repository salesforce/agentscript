...
export function ConditionalNode({ data }: NodeProps<GraphNode>) {
  ...
  return (
    <div className="group/cond relative">
      <div className="min-w-50 rounded-lg border border-indigo-300 bg-white shadow-md transition-colors duration-150 hover:border-indigo-400 dark:border-indigo-500/40 dark:bg-zinc-800 dark:hover:border-indigo-400/60">
        {/* Single target handle — top center */}
        <Handle
          type="target"
          position={Position.Top}
          id="top"
          className="h-2! w-2! border-[1.5px]! border-white! bg-gray-400! dark:border-zinc-800! dark:bg-gray-500!"
        />
      ...
      {fullCondition && (
        <div className="pointer-events-none absolute top-full left-1/2 z-50 mt-1.5 hidden w-max max-w-100 -translate-x-1/2 group-hover/cond:block">
          <div className="rounded-lg border border-gray-200 bg-white p-2.5 shadow-lg dark:border-gray-600 dark:bg-zinc-900">
