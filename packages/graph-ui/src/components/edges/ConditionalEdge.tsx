...
import type { ConditionalEdgeData } from '../../ast/ast-to-graph';
...
export function ConditionalEdge({
  ...
  const { highlightedEdgeIds, onConditionalClick } = useGraphContext();
  ...
  return (
    ...
    >
      ...
      {Array.from({ length: CHEVRON_COUNT }, (_, i) => {
        const begin = `${(i * DURATION) / CHEVRON_COUNT}s`;
        return (
          <polygon
            key={i}
            points="0,-4 7,0 0,4"
